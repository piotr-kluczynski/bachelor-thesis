...
from display_module.lobby.settings_entry import SettingsEntry
...
class SettingsList(tk.Frame):
    def __init__(self, parent, setting_list):
        ...
        self.populate_list(setting_list)

    def populate_list(self, setting_list):
        for setting_name, setting_value in setting_list.items():
            SettingsEntry(
    ...
    def refresh_list(self, setting_list):
